...
log4js.configure = function (config) {
    config.appenders = Object.assign(taLog4jsConfiguration.appenders, config.appenders);
    config.categories = Object.assign(taLog4jsConfiguration.categories, config.categories);
    oldLog4jsConfigure(config);
}
